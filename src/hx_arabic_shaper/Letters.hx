...
class Letters {
  public static inline var UNSHAPED = 255;
  public static inline var ISOLATED = 0;
  public static inline var INITIAL = 1;
  public static inline var MEDIAL = 2;
  public static inline var FINAL = 3;
  
  public static inline var TATWEEL = '\u0640';
  public static inline var ZWJ = '\u200D';

  public static var LETTERS = [
    // ARABIC LETTER HAMZA
    '\u0621' => ['\uFE80', '', '', ''],
  ...
  public static function connects_with_letter_before(letter) {
    if (!LETTERS.exists(letter)) {
      return false;
    }
    var forms = LETTERS.get(letter);
    return forms[FINAL] != "" || forms[MEDIAL] != "";
  }

  public static function connects_with_letter_after(letter) {
    if (!LETTERS.exists(letter)) {
      return false;
    }
    var forms = LETTERS.get(letter);
  ...
  public static function connects_with_letters_before_and_after(letter) {
    if (!LETTERS.exists(letter)) {
      return false;
    }
    var forms = LETTERS.get(letter);
